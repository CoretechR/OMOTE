...
void Display::display_settings(lv_obj_t* parent)
{
  ...
  lv_obj_add_event_cb(slider, bl_slider_event_cb, LV_EVENT_VALUE_CHANGED, &this->backlight_brightness);
  ...
  lv_obj_set_style_bg_color(drop, this->primary_color, LV_PART_MAIN);
  lv_obj_set_style_bg_color(lv_dropdown_get_list(drop), this->primary_color, LV_PART_MAIN);
