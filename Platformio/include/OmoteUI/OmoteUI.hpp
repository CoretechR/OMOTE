...
/// @brief Singelton to allow UI code to live seprately from the Initialziation.
class OmoteUI
{
public:
    OmoteUI(std::shared_ptr<HardwareAbstractionInterface> aHardware) : mHardware(aHardware) { lv_init(); };

    static std::weak_ptr<OmoteUI> getRefrence()
    {
        return getInstance();
    };
    static std::shared_ptr<OmoteUI> getInstance(std::shared_ptr<HardwareAbstractionInterface> aHardware = nullptr)
    {
        if (mInstance)
        {
            return mInstance;
...
private:
    ...
    inline static const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST uint8_t gradientLeft_map[] = {
        0xfa,
        0xf2,
        0xea,
        0xe2,
    ...
    inline static const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST uint8_t gradientRight_map[] = {
        0x07,
        0x0f,
        0x17,
        0x1f,
    ...
    inline static const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST uint8_t appleTvIcon_map[] = {
    ...
    inline static const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST uint8_t appleDisplayIcon_map[] = {
        0x23,
        0xc6,
        0xff,
        0xff,
    ...
    inline static const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST uint8_t appleBackIcon_map[] = {
        0x00,
        0x00,
        0x00,
        0x00,
    ...
    inline static const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST uint8_t high_brightness_map[] = {
        0x00,
        0x00,
        0x00,
        0x00,
    ...
    inline static const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST uint8_t low_brightness_map[] = {
        0x00,
        0x00,
        0x00,
        0x00,
    ...
    inline static const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST uint8_t lightbulb_map[] = {
        0x00,
        0x00,
        0x00,
        0x00,
    ...
    inline static const uint_fast8_t virtualKeyMapTechnisat[10] = {0x1, 0x2, 0x3, 0x4, 0x5, 0x6, 0x7, 0x8, 0x9, 0x0};
};
